...
<!-- saved from url=(0063)http://malwarecookbook.googlecode.com/svn/trunk/4/4/avsubmit.py -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">#!/usr/bin/python
