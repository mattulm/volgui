rule CrowdStrike_PutterPanda_02 {
        meta:
...
rule CrowdStrike_PutterPanda_03 {
        meta:
...
rule CrowdStrike_PutterPanda_04 {
        meta:
...
rule CrowdStrike_PutterPanda_05 {
        meta:
...
rule CrowdStrike_PutterPanda_06 {
        meta:
...
rule CrowdStrike_CSIT_14003_03_installer {
       meta:
             copyright = "CrowdStrike, Inc"
...
rule CrowdStrike_FlyingKitten_rat {
      meta:
            copyright = "CrowdStrike, Inc"
             author = "Crowdstrike"
