...
EQUATION GROUP YARA RULES

These rules are not the ones published by Kaspersky in the original report.
They were derived from the samples listed with MD5 hash on page 32 and 33 of this FAQs and Appendix published by Kaspersky https://securelist.com/files/2015/02/Equation_group_questions_and_answers.pdf

To get a complete signature set add the Yara rules that were published in the original report.
http://securelist.com/blog/research/68750/equation-the-death-star-of-malware-galaxy/

Check your systems with these rules and all the published IOCs using the FREE IOC Scanner LOKI
https://github.com/Neo23x0/Loki

Please report back false positives via private message here on pastebin - state filename and a hash (MD5/SHA1/SHA256).

v1.1
17.02.2015 

CHANGES:
1.1 Added a new rule based on suspicious keywords and strings 
...
/* Rule derived from the mentioned strings in the FAQ paper on page 19 */
